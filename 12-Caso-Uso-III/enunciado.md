...
Com base no cenário apresentado, os alunos deverão:
    ...
    Identificar corretamente os atores do sistema;
    Identificar os casos de uso principais;
    Descobrir relacionamentos de:
        associação;
        include;
        extend;
        generalização/herança;
    Elaborar um diagrama de casos de uso completo;
    Produzir pelo menos um caso de uso expandido detalhado;
